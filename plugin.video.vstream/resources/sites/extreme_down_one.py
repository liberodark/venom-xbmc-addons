...
URL_MAIN = 'https://extreme-down.one/' #url de votre source
...
MOVIE_NEWS = (URL_MAIN + 'films-sd/', 'showMovies') # films (derniers ajouts)
MOVIE_EXCLUS = (URL_MAIN + 'top/', 'showMovies') # exclus (films populaires)
MOVIE_MOVIE = (URL_MAIN + 'films-hd/', 'showMovies') #films vrac
MOVIE_HDLIGHT = (URL_MAIN + 'films-hdlight/', 'showMovies') #films HD
MOVIE_HDLIGHT_720P = (URL_MAIN + 'films-hdlight/hdlight-720p/', 'showMovies') #films HD
MOVIE_HDLIGHT_1080P = (URL_MAIN + 'films-hdlight/hdlight-1080p/', 'showMovies') #films HD
MOVIE_MOVIEHD_720P = (URL_MAIN + 'films-hd/bluray-720p/', 'showMovies') #films vrac
